...
export async function seed({ userId } = {}) {
  ...
  COMPANIES.forEach((row, i) => {
    ...
    const company = {
      ...
      stage: 'New', call_status: 'new', attempts: 0, no_answer_count: 0,
  ...
  const story = [
    ...
    ], { stage: 'Contacted', call_status: 'contacted', attempts: 3 }],
    ...
    ], { stage: 'Meeting Booked', call_status: 'contacted', attempts: 3 }],
    ...
    ], { stage: 'Proposal', call_status: 'contacted', attempts: 4 }],
  ...
  await insertMany('opportunities', [
    {
      ...
      mrr: 1800, one_off: 0, close_date: addDays(t, -5), probability: 100, stage: 'Won',
    ...
    },
    {
      ...
      mrr: 2400, one_off: 1200, close_date: addWorkingDays(t, 10), probability: 50, stage: 'Proposal',
    ...
    },
    {
      ...
      mrr: 3200, one_off: 0, close_date: addWorkingDays(t, 15), probability: 40, stage: 'Meeting Booked',
    ...
    },
    {
      ...
      mrr: 1600, one_off: 2000, close_date: addWorkingDays(t, 20), probability: 25, stage: 'Contacted',
