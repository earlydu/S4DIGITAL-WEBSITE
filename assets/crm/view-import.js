...
import { $, $$, esc, toast, humanStamp, loading, empty } from './ui.js?v=12';
import { readSheet } from './sheet.js?v=12';
...
function wire() {
  ...
  if (goto) goto.onclick = async () => { (await import('./nav.js?v=12')).go(goto.dataset.goto); };
