...
import { $, $$, esc, toast, humanStamp, loading, empty } from './ui.js?v=11';
import { readSheet } from './sheet.js?v=11';
...
function wire() {
  ...
  if (goto) goto.onclick = async () => { (await import('./nav.js?v=11')).go(goto.dataset.goto); };
